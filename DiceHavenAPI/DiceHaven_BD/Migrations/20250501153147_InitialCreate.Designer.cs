...
namespace DiceHaven_BD.Migrations
{
    ...
    [Migration("20250501153147_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_campanha", b =>
                {
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_campo_ficha", b =>
                {
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_chat", b =>
                {
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_chat_mensagem", b =>
                {
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_config_usuario", b =>
                {
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_dados_ficha", b =>
                {
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_personagem", b =>
                {
                    b.Property<int>("ID_PERSONAGEM")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_usuario", b =>
                {
                    b.Property<int>("ID_USUARIO")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_usuario_campanha", b =>
                {
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_usuario_contato", b =>
                {
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_campanha", b =>
                {
                    b.HasOne("DiceHaven_BD.Models.tb_usuario", "ID_MESTRE_CAMPANHANavigation")
                        .WithMany("tb_campanhaID_MESTRE_CAMPANHANavigations")
                        .HasForeignKey("ID_MESTRE_CAMPANHA")
                        .IsRequired()
                        .HasConstraintName("tb_campanha_ibfk_2");

                    b.HasOne("DiceHaven_BD.Models.tb_usuario", "ID_USUARIO_CRIADORNavigation")
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_campo_ficha", b =>
                {
                    b.HasOne("DiceHaven_BD.Models.tb_campanha", "ID_CAMPANHANavigation")
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_chat", b =>
                {
                    b.HasOne("DiceHaven_BD.Models.tb_usuario", "ID_USUARIO_1Navigation")
                        .WithMany("tb_chatID_USUARIO_1Navigations")
                        .HasForeignKey("ID_USUARIO_1")
                        .IsRequired()
                        .HasConstraintName("tb_chat_ibfk_1");

                    b.HasOne("DiceHaven_BD.Models.tb_usuario", "ID_USUARIO_2Navigation")
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_chat_mensagem", b =>
                {
                    b.HasOne("DiceHaven_BD.Models.tb_chat", "ID_CHATNavigation")
                        .WithMany("tb_chat_mensagems")
                        .HasForeignKey("ID_CHAT")
                        .IsRequired()
                        .HasConstraintName("tb_chat_mensagem_ibfk_2");

                    b.HasOne("DiceHaven_BD.Models.tb_usuario", "ID_USUARIONavigation")
                        .WithMany("tb_chat_mensagems")
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_config_usuario", b =>
                {
                    b.HasOne("DiceHaven_BD.Models.tb_usuario", "ID_CONFIG_USUARIONavigation")
                        .WithOne("tb_config_usuario")
                        .HasForeignKey("DiceHaven_BD.Models.tb_config_usuario", "ID_CONFIG_USUARIO")
                        .IsRequired()
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_dados_ficha", b =>
                {
                    b.HasOne("DiceHaven_BD.Models.tb_campo_ficha", "ID_CAMPO_FICHANavigation")
                        .WithMany("tb_dados_fichas")
                        .HasForeignKey("ID_CAMPO_FICHA")
                        .IsRequired()
                        .HasConstraintName("tb_dados_ficha_ibfk_1");

                    b.HasOne("DiceHaven_BD.Models.tb_personagem", "ID_PERSONAGEMNavigation")
                        .WithMany("tb_dados_fichas")
            ...
            modelBuilder.Entity("DiceHaven_BD.Models.tb_usuario_contato", b =>
                {
                    b.HasOne("DiceHaven_BD.Models.tb_usuario", "ID_CONTATONavigation")
